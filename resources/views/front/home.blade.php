    ...
    <div class="absolute inset-0   bg-gradient-to-r from-[#15549a]/90 via-[#15549a]/90 to-[#fff]/90 flex items-center">
        ...
        <div class="container p-5 mx-auto my-5 grid grid-cols-2   md:gap-90">
            ...
            <div class="">
              ...
              <a href="{{  route("login") }}"> <button class="px-6 py-3 bg-[#bc872b] hover:bg-[#bc872b] text-white font-semibold rounded-lg shadow-md hover:opacity-90 transition duration-300">
                 J'en profite
                </button></a>
            </div>
